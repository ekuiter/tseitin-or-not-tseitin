...
# The point of this file is to extract DIMACS files (i.e., CNFs) for a representative selection of configurable systems based on the Kconfig configuration language.
